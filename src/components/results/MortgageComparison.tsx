          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-muted-foreground uppercase border-b border-white/10">
              <tr>
                ...
                <th className="px-6 py-3">With Collateral (0% Down)</th>
                {consumerLoanOption && <th className="px-6 py-3">With Consumer Loan</th>}
            ...
            <tbody>
              <tr className="bg-card border-b border-border">
                ...
                <td className="px-6 py-4 text-secondary font-bold">€{collateral.downPayment.toLocaleString()}</td>
                {consumerLoanOption && <td className="px-6 py-4 text-foreground">€{consumerLoanOption.downPayment.toLocaleString()}</td>}
              ...
              <tr className="bg-card border-b border-border">
                ...
                <td className="px-6 py-4 text-foreground">€{collateral.loanAmount.toLocaleString()}</td>
                {consumerLoanOption && <td className="px-6 py-4 text-foreground">€{consumerLoanOption.loanAmount.toLocaleString()}</td>}
              ...
              <tr className="bg-card border-b border-border">
                ...
                <td className="px-6 py-4 text-foreground">{collateral.loanTerm} years</td>
                {consumerLoanOption && <td className="px-6 py-4 text-foreground">{consumerLoanOption.loanTerm} years</td>}
              ...
              >
                ...
                <td className="px-6 py-4 text-foreground">€{collateral.monthlyPayment.toFixed(2)}</td>
                {consumerLoanOption && <td className="px-6 py-4 text-foreground font-bold">€{consumerLoanOption.monthlyPayment.toFixed(2)}</td>}
              ...
              {showConsumerDetails && (consumerLoanOption?.consumerLoanMonthlyPayment || userSelection?.consumerLoanMonthlyPayment) && (
                <>
                  <tr className="bg-muted/20 border-b border-border">
                    ...
                    <td className="px-6 py-1 text-muted-foreground text-xs">-</td>
                    {consumerLoanOption && <td className="px-6 py-1 text-foreground text-xs">€{consumerLoanOption.consumerLoanMonthlyPayment?.toFixed(2)}</td>}
