...
export interface IEmergencyFundCalculator {
  calculate(
...
export class StandardEmergencyFundCalculator implements IEmergencyFundCalculator {
  calculate(
    monthlyFixedExpenses: number,
    monthlyVariableExpenses: number,
    monthlyChildCosts: number,
...
const defaultCalculator = new StandardEmergencyFundCalculator();
...
export function calculateEmergencyFund(
  ...
  return defaultCalculator.calculate(
